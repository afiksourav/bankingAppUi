...
import 'package:mobile_list_animaiton/home_page/tabs/home/savings_model.dart';
import 'package:mobile_list_animaiton/home_page/tabs/profile/profile_picture_name.dart';
import 'package:mobile_list_animaiton/notification_page/notification_page.dart';
...
class HomeTab extends StatelessWidget {
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: Color.fromARGB(255, 236, 218, 52),
                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            for (final model in CircularIconModel.savings) getCircularIcons(model),
                            getCircularIcons(CircularIconModel(icon: Icons.add, progressValue: 0), false, true),
                          ],
                        ),
                      ],
                    ),
  ...
  Container getCircularIcons(CircularIconModel model, [bool showProgress = true, bool showShadow = false, Color? containerColor, Color? iconColor]) {
    return Container(
      height: 35,
      width: 38,
